...
public class Book {
    ...
    public String toString() {
        String res = "Book{" + "name='" + name + '\'' + ", author='" + author + '\'';
        if(edition > 0)
                res += ", publisher='" + publisher + '\'' +", edition=" + edition  +", publishYear=" + publishYear+'}';
    ...
    public void setEdition(int edition) {
        if(edition < 0) throw new IllegalArgumentException("he can't be below 0!");
